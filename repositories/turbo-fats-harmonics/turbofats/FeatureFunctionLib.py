...
class FluxPercentileRatioMid80(Base):
    ...
    def fit(self, data):
        ...
        F_10_index = math.floor(0.10 * lc_length) # ceil
        F_90_index = math.floor(0.90 * lc_length) # ceil
        F_5_index = math.floor(0.05 * lc_length) # ceil
        F_95_index = math.floor(0.95 * lc_length)
...
class PercentDifferenceFluxPercentile(Base):
    ...
    def fit(self, data):
        ...
        lc_length = len(sorted_data)
        F_5_index = math.floor(0.05 * lc_length) # ceil
        F_95_index = math.floor(0.95 * lc_length) # ceil
        #print(lc_length, F_5_index, F_95_index)
        #F_5_95 = sorted_data[F_95_index] - sorted_data[F_5_index]
        #F_5_95 = sorted_data[min(F_95_index, lc_length-1)] - sorted_data[F_5_index] # nan
        F_5_95 = sorted_data[F_95_index] - sorted_data[F_5_index]
